...
<div className="welcome-banner">
  <img src="/logo.png" className="animate-logo" />
  <img src="/logo-without-background.png" className="over-wrap" />
</div>
...
Developed by <u><a href="https://github.com/leegeunhyeok">Geunhyeok LEE (@leegeunhyeok)</a></u>
</div>
